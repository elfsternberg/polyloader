...
version = polyloader.__version__
# The full version, including alpha/beta/rc tags.
release = polyloader.__version__
...
htmlhelp_basename = 'polyloaderdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'polyloader.tex',
     u'polyloader Documentation',
